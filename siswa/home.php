...
if (isset($_GET['cari'])) {
  $cari = $_GET['cari'];
  $str = "SELECT * FROM pembayaran as a JOIN siswa as b ON a.nisn = b.nisn JOIN kelas as c ON b.id_kelas = c.id_kelas WHERE a.nisn = '$uid' b.nama LIKE '%$cari%' ";
  // cek pilih kelas
  if (isset($_GET['kelas'])) {
    $kelas = $_GET['kelas'];
  ...
  $query = query("SELECT * FROM pembayaran as a JOIN siswa as b ON a.nisn = b.nisn JOIN kelas as c ON b.id_kelas = c.id_kelas WHERE a.nisn = '$uid'");
}
$printAll = $query;
...
if (isset($_GET['cari'])) {
  ...
  $query = query("SELECT * FROM pembayaran as a JOIN siswa as b ON a.nisn = b.nisn JOIN kelas as c ON b.id_kelas = c.id_kelas Where a.nisn = '$uid' ORDER BY id_pembayaran DESC LIMIT " . $limit . "," . $baris);
}
// get semua kelas
